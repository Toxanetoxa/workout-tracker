...
const docTemplate = `{
    ...
    "paths": {
        "/executions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные выполнения",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateExecutionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.UserStatistics"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.UserStatistics": {
            ...
            "properties": {
                "last_7_days": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.DailyExecutionCount"
                    }
                },
                "today": {
                    "type": "integer"
        ...
        "handlers.CreateExecutionRequest": {
            "type": "object",
            "required": [
                "exercise_id",
                "user_id"
